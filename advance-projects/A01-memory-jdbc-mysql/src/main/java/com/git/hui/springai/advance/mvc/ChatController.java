 ...
 * 对话记忆流程：
 * <ol>
 *     <li>用户发送消息，MessageChatMemoryAdvisor 根据 conversationId 从 MySQL 加载历史对话</li>
 *     <li>历史消息 + 当前消息一起发送给大模型</li>
 *     <li>大模型返回响应后，Advisor 自动将本轮对话（用户消息 + AI 回复）持久化到 MySQL</li>
 * </ol>
 *
 * @author YiHui
 * @date 2025/8/5
...
public class ChatController {
     ...
     * @param chatMemory 对话记忆组件（由 MemConfig 配置，底层为 MySQL JDBC 存储）
     */
