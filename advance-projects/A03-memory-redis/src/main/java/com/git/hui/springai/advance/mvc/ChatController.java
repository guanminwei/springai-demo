...
/**
 * AI 对话控制器 - 提供带记忆能力的聊天接口（Redis 存储版）
 * <p>
 ...
 * <ul>
 *     <li>读写性能高，适合高并发场景</li>
 *     <li>支持分布式部署，多实例共享对话状态</li>
 *     <li>可配置 TTL 实现对话自动过期</li>
 * </ul>
 *
 * @author YiHui
 * @date 2025/8/5
...
public class ChatController {
     ...
     * @param chatMemory 对话记忆组件（由 MemConfig 配置，底层为 Redis 存储）
     */
